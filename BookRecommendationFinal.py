...
popularity=pickle.load(open('popular.pkl','rb'))
...
add_bg_from_local('C:/Users/Abc/Desktop/group_project/WhatsApp Image 2022-11-29 at 4.30.34 PM.jpeg')


#Functions for each of the pages

def page1(popularity):
    st.markdown(f'<h2 style="color: #E6E6FA;font-family:Verdana, sans-serif; font-size:25px;">{"Latest & Trending Books:"}</h2>', unsafe_allow_html=True)
...
def Page2(books_name):
    st.markdown(f'<h2 style="color: #E6E6FA;font-family:Verdana, sans-serif; font-size:25px;">{"Books Recommended for you:"}</h2>', unsafe_allow_html=True)
...
if option == 'Latest & Trending Books':
  ...
  Page2(books_name)
    ...
    st.markdown(f'<h2 style="color: #E6E6FA;font-family:Verdana, sans-serif; font-size:25px;">{"Books by same Author:"}</h2>', unsafe_allow_html=True)
...
image = Image.open('C:\Users\Abc\Desktop\group_project\WhatsApp Image 2022-12-08 at 7.38.39 PM.jpeg')
